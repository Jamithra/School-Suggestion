      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          IF(ISSET($_POST['logout'])){
            echo "<script language=\"javascript\">confirm(\"Are you sure you want to log out? \");document.location.href='p_login.php';</script>";
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="leaderboard.php">Leader Board<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Leader Board of CITY:</h2><hr>
          ...
          <div class="table-responsive">
           ...
           $retval="SELECT * FROM student WHERE location_id=$l_id";
